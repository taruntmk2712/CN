...
std::cout<<" t.sourceAddress="<<t.sourceAddress<<"t.destination Address="<<t.destinationAddress<<"Source port:"<<t.sourcePort<<""<<"Destination port:"<<t.destinationPort<<"\n";
...
/*OUTPUT:
 t.sourceAddress=10.1.1.1t.destination Address=10.1.1.2Source port:49153Destination port:8000
